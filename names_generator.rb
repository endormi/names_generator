...
if "#{l}-#{r}" == "boring-wozniak"
  # Conditional as seen on the names_generator-code
  # In the example code it redoes the code and gets a different
  # result but I just decided to keep this
  puts "Wozniak is not boring!"
else
  puts "#{l}-#{r}"
end
